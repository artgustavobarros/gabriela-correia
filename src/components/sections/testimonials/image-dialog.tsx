    ...
    <Dialog>
      <DialogTrigger className="cursor-pointer">
        <div className="relative max-h-[400px] group rounded-lg">
          ...
          />
          <div className="bg-white rounded-full text-brand-500 absolute left-1/2 -translate-x-1/2 bottom-2 py-2 px-6 z-[1] font-martel font-bold group-hover:bg-brand-500 group-hover:text-white duration-500 ease-in-out">
            Visualizar
          </div>
        </div>
      </DialogTrigger>
